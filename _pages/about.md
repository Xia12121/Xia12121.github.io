...
<ul class="hp-news">
  ...
  <li>
    ...
    <span class="hp-badge">Accepted</span>
    🎉 Our paper <strong>"Continuous-Time Modeling of Crypto Limit Order Books with Liquid Neural Networks"</strong> (Paper&nbsp;#384) has been accepted by the <strong>Asia Pacific Web and Web-Age Information Management Joint International Conference on Web and Big Data (APWeb-WAIM 2026)</strong>, a <strong>CCF-C</strong> conference. Many thanks to the program committee and all collaborators!
  </li>
</ul>
